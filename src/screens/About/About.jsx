...
import { AboutTitle, LogoImage, AboutText, IconLabel } from './styles'
    ...
    <View style={{ backgroundColor: colors.BACKGROUND, flex: 1 }}>
      ...
      <View style={{alignItems: 'center', flex: 1}}>
        ...
        <AboutText>
          ...
          an environment dedicated to this purpose, and that they can interact with other people, adding ideas in a healthy way.
        </AboutText>
