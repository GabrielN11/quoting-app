...
export default function SeenPublicationsList({navigation}) {
    ...
    async function getPublications(){
        setLoading(true)
        try{
            const json = await fetch(API_URL + '/seen-publications/' + user.id + '?page=' + page, {
                headers: {
  ...
  return (
    <ScrollView style={{height: '100%', backgroundColor: colors.BACKGROUND}}>
        ...
        <ProfileText style={{alignSelf: 'center'}}>Publications you've seen</ProfileText>
